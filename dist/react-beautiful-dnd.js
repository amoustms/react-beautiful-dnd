  ...
  */
  ...
  _ref) {
    ...
    return function wrapWithConnect(WrappedComponent) {
      // if ("development" !== 'production' && !isValidElementType(WrappedComponent)) {
      ...
      function ConnectFunction(props) {
        ...
        var ContextToUse = React.useMemo(function () {
          ...
          return propsContext && propsContext.Consumer && !!( /*#__PURE__*/React__default.createElement(propsContext.Consumer, null)) ? propsContext : Context;
  ...
  var _getClosestScrollable = function getClosestScrollable(el) {
    if (el == null) {
      return null;
    }
    if (el === document.body) {
    ...
    if (!isElementScrollable(el)) {
      return _getClosestScrollable(el.parentElement);
    }
    return el;
  };
  ...
  var checkForNestedScrollContainers = (function (scrollable) {
    ...
    var anotherScrollParent = _getClosestScrollable(scrollable.parentElement);
  ...
  var _getIsFixed = function getIsFixed(el) {
    if (!el) {
      return false;
    }
    var style = window.getComputedStyle(el);
    ...
    return _getIsFixed(el.parentElement);
  };
  var getEnv = (function (start) {
    var closestScrollable = _getClosestScrollable(start);
    var isFixedOnPage = _getIsFixed(start);
    return {
